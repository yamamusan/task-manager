...
このトレーニングは、株式会社万葉さんをベースにして作成しています。
...
### ステップ7: タスクを登録・更新・削除するAPIを作成しましょう

- タスクの一覧API、作成API、詳細API、更新APIを作成しましょう
...
- タスクの一覧画面、作成画面、詳細画面、編集画面を作成しましょう
  - 作成、詳細、編集はこ画面風にしてみましょう

### ステップ9: テスト（feature spec）を書こう
